...
export const Container: React.FC<ContainerProps> = ({
  ...
  const style = useMemo(
    ...
    [alignItems, display, flexDirection, height, justifyContent, position, width]
  );
  return (
...
export const Rows: React.FC<RowsProps> = ({alignItems, children, justifyContent}) => {
  const style = useMemo(() => ({
    display: 'flex',
    flexDirection: 'row',
    alignItems,
    justifyContent
  } as React.CSSProperties), [alignItems, justifyContent])
  return (
    <div style={style}>
      {children}
    </div>
...
export const Columns: React.FC<ColumnsProps> = ({children, gapless, oneLine}) => (
  <div
